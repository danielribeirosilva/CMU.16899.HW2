...
%% configuration by performing a search (using Nelder-Mead, approximate gradient methods, etc...)
%% over a space of policies. Use the 'real' non-linear model, not linearized dynamics.
%% We suggest starting with a simple linear controller class, but you should
